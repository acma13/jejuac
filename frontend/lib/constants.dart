...
class Config {
  ...
  // 실제 서버는 이것으로 사용 할 것!!!
  static const String baseUrl = "https://jejuac.duckdns.org";
  ...
  // 클럽 일지 관련
  static const String addClubDailylog = "$baseUrl/api/add_club_dailylog";
  static const String getClubDailylogs = "$baseUrl/api/get_club_dailylogs";
